...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Widget'
        db.create_table(u'cmsplugin_widget', (
            (u'cmsplugin_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['cms.CMSPlugin'], unique=True, primary_key=True)),
            ('heading', self.gf('django.db.models.fields.CharField')(default='Title', max_length=100)),
            ('body', self.gf('django.db.models.fields.TextField')(default='Body')),
        ))
        db.send_create_signal(u'plugins', ['Widget'])


    def backwards(self, orm):
        # Deleting model 'Widget'
        db.delete_table(u'cmsplugin_widget')
    ...
    models = {
        ...
        u'plugins.widget': {
            ...
            'body': ('django.db.models.fields.TextField', [], {'default': "'Body'"}),
            u'cmsplugin_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['cms.CMSPlugin']", 'unique': 'True', 'primary_key': 'True'}),
            'heading': ('django.db.models.fields.CharField', [], {'default': "'Title'", 'max_length': '100'})
        }
    }
