...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'Featurette'
        db.delete_table(u'cmsplugin_featurette')

        # Adding model 'Credential'
        db.create_table(u'cmsplugin_credential', (
        ...
        db.send_create_signal(u'plugins', ['Credential'])


    def backwards(self, orm):
        # Adding model 'Featurette'
        db.create_table(u'cmsplugin_featurette', (
            ('description', self.gf('django.db.models.fields.TextField')(default='Description')),
            ('image', self.gf('django.db.models.fields.files.ImageField')(max_length=100)),
            (u'cmsplugin_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['cms.CMSPlugin'], unique=True, primary_key=True)),
            ('inverted', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ...
        db.send_create_signal(u'plugins', ['Featurette'])

        # Deleting model 'Credential'
        db.delete_table(u'cmsplugin_credential')
