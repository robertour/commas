...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Featurette.inverted'
        db.add_column(u'cmsplugin_featurette', 'inverted',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Featurette.inverted'
        db.delete_column(u'cmsplugin_featurette', 'inverted')
