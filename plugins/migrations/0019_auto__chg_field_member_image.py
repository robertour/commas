...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'cmsplugin_member', 'image', self.gf('django_jcrop.models.JCropImageField')(max_length=100))

    def backwards(self, orm):

        # Changing field 'Member.image'
        db.alter_column(u'cmsplugin_member', 'image', self.gf('django.db.models.fields.files.ImageField')(max_length=100))
