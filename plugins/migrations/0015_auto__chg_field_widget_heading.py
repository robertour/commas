...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Widget.heading'
        db.alter_column(u'cmsplugin_widget', 'heading', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

    def backwards(self, orm):

        # Changing field 'Widget.heading'
        db.alter_column(u'cmsplugin_widget', 'heading', self.gf('django.db.models.fields.CharField')(max_length=100))
