...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Featurette.description'
        db.alter_column(u'cmsplugin_featurette', 'description', self.gf('django.db.models.fields.TextField')())

    def backwards(self, orm):

        # Changing field 'Featurette.description'
        db.alter_column(u'cmsplugin_featurette', 'description', self.gf('django.db.models.fields.CharField')(max_length=100))
