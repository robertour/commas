...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table(u'plugins_sociallinks')

        # Adding model 'SocialLink'
        db.create_table(u'plugins_sociallink', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('plugin', self.gf('django.db.models.fields.related.ForeignKey')(related_name='associated_link', to=orm['plugins.Member'])),
            ('social_network', self.gf('django.db.models.fields.CharField')(default='default', max_length=100, null=True, blank=True)),
            ('url', self.gf('django.db.models.fields.URLField')(default=None, max_length=200)),
            ('icon', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['filer.Image'], null=True, blank=True)),
        ))
        db.send_create_signal(u'plugins', ['SocialLink'])


    def backwards(self, orm):
        # Adding model 'SocialLinks'
        db.create_table(u'plugins_sociallinks', (
            ('plugin', self.gf('django.db.models.fields.related.ForeignKey')(related_name='associated_link', to=orm['plugins.Member'])),
            ('url', self.gf('django.db.models.fields.URLField')(default=None, max_length=200)),
            ('social_network', self.gf('django.db.models.fields.CharField')(default='default', max_length=100, null=True, blank=True)),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal(u'plugins', ['SocialLinks'])

        # Deleting model 'SocialLink'
        db.delete_table(u'plugins_sociallink')
    ...
    models = {
        ...
        u'plugins.member': {
            ...
            u'cmsplugin_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['cms.CMSPlugin']", 'unique': 'True', 'primary_key': 'True'}),
            'description': ('django.db.models.fields.TextField', [], {'default': "'Description'"}),
            'image': ('django_jcrop.models.JCropImageField', [], {'max_length': '100', 'blank': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'default': "'Name'", 'max_length': '100'}),
        ...
        u'plugins.sociallink': {
            'Meta': {'object_name': 'SocialLink'},
            'icon': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['filer.Image']", 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'plugin': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'associated_link'", 'to': u"orm['plugins.Member']"}),
            'social_network': ('django.db.models.fields.CharField', [], {'default': "'default'", 'max_length': '100', 'null': 'True', 'blank': 'True'}),
